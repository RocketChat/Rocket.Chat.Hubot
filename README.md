# Rocket.Chat.Hubot
An example Implementation of hubot using our [hubot-rockectchat](https://github.com/RocketChat/hubot-rocketchat) adapter.  This is the bot in use on our demo server https://demo.rocket.chat
